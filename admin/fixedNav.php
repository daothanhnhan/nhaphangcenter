    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <!-- <li><a href="/import" title=""
                   class="linkMenu " target="_blank"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhập Excel</a>
            </li> -->

            <li><a href="http://www.bidv.com.vn/Ty-gia-ngoai-te.aspx" title=""
                   class="linkMenu " target="_blank"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tỷ giá tham khảo</a>
            </li>
