<?php
    ...
    $totalPrice = 0;
    // echo $cart->sw_get_current_weekday();die;

    if (isset($_SESSION['user_id_gbvn'])) {
      $user_get = getUser();
      $user_name = $user_get['name'];
      $user_email = $user_get['email'];
      $user_phone = $user_get['phone'];
      $user_address = $user_get['address'];
    } else {
      $user_name = '';
      $user_email = '';
      $user_phone = '';
...
<script>  
 $(document).ready(function(data){  
      ...
      $(document).on('keyup', '.quantity', function(){  
           var product_id = $(this).data("product_link");  
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <form action="" method="POST" role="form" id="formPayment">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txtName" id="inputTxtName" value="<?= $user_name ?>" placeholder="Nhập Họ Tên" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Email:</label>
                                <input type="email" class="form-control" name="txtEmail" id="inputTxtEmail" value="<?= $user_email ?>" placeholder="Nhập Email" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Điện thoại <span style="color:#C03;">(*)</span>:</label>
                                <input type="tel" class="form-control" name="txtPhone" id="inputTxtPhone" value="<?= $user_phone ?>" placeholder="Nhập Số Điện Thoại" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Địa chỉ <span style="color:#C03;">(*)</span>:</label>
                                <input type="text" class="form-control" name="txtAddress" id="inputTxtAddress" value="<?= $user_address ?>" placeholder="Nhập Địa Chỉ Nhận Hàng" required="required">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="table-responsive" id="order_table">  
                               <table class="table table-bordered">  
                                    ...
                                    <tr>  
                                         ...
                                         <td><input type="text" name="quantity[]" id="quantity<?php echo $values["product_id"]; ?>" value="<?php echo $values["product_quantity"]; ?>" data-product_link="<?php echo $values["product_link"]; ?>" class="form-control quantity" /></td>  
                                         <td align="right"><?php echo number_format($values["product_price"], 2); ?> Tệ</td>  
                                         <td align="right"><?php echo number_format($values["product_quantity"] * $values["product_price"], 2); ?> Tệ</td>  
                                        <!--  <td><button name="delete" class="btn btn-danger btn-xs delete" id="<?php echo $values["product_link"]; ?>">Remove</button></td>   -->
                                    </tr>  
                                    <?php  
                                    ...
                                    <tr>  
                                         ...
                                         <td align="right"><?php echo number_format($total, 2); ?> Tệ</td>  
                                        <!--  <td></td>   -->
                                    </tr>  
                                    <tr>  
